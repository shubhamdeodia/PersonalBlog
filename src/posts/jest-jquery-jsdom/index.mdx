...
1. Create a mock function wherever Jquery function call is being made
2. Instantiate Jquery with a document object globally in your test environment

In this post, we will talk about the second approach
...
And the way we resolve Jquery, we provide it with the Window object in the fnction returned by Jquery module.
